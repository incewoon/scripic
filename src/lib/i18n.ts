...
const dict = {
  en: {
    ...
    photoPermTitle: "Let Memory Weaver see your photos",
    photoPermDesc: "Pick the photos you'd like to weave into a story. Memory Weaver only opens the ones you choose.",
    ...
    backupInvalid: "This file isn't a valid Memory Weaver backup.",
    ...
    themeWarmDesc: "Soft beige & coral — the original Memory Weaver look.",
  ...
  ko: {
    ...
    backupInvalid: "올바른 Memory Weaver 백업 파일이 아니에요.",
    ...
    themeWarm: "웜 크림",
    themeWarmDesc: "포근한 베이지와 코랄 — 기본 Memory Weaver 분위기예요.",
