...
const dict = {
  en: {
    ...
    backupInfoStep2: "Enter your PIN. All albums, photos, and theme settings are bundled into an encrypted .moarabak file and saved to your device.",
    backupInfoStep3: "To restore, tap \"Restore from backup file\", pick the .moarabak file, and enter the same PIN.",
  ...
  ko: {
    ...
    backupInfoStep2: "PIN을 입력하면 모든 앨범·사진·테마 설정이 암호화된 .moarabak 파일로 만들어져 기기에 저장돼요.",
    backupInfoStep3: "복원할 때는 \"백업 파일에서 복원\"을 누르고 같은 PIN으로 .moarabak 파일을 선택하면 돼요.",
