...
const dict = {
  en: {
    ...
    myAlbums: "My Albums",
    loading: "Loading…",
    firstMemoryTitle: "Leave your first story",
    firstMemoryTagline: "Capture memories beyond what photos can hold",
    firstMemoryHint: "1 to 3 photos is all it takes",
    photosCount: (n: number) => `${n} photo${n === 1 ? "" : "s"}`,
    delete: "Delete",
    confirmDelete: "Delete this album?",
    deleted: "Album deleted",
    newAlbum: "Create Story",
    ...
    offlineNotice: "No internet connection. Please check your network.",
    connectionError: "Connection problem",
    incompleteResponse: "The AI response was cut off. Want to try again?",
    incompleteRetry: "Try again",
    incompleteResponseFinal: "Chat is having a hard time right now. Please try again in a little while.",
    edit: "Edit",
    save: "Save",
    cancel: "Cancel",
    title: "Title",
    ...
    viewNow: "View now",
    savedToDocuments: "Saved to your folder",
    ...
    backupInfoPinBody:
      "Every backup is encrypted with a 4-digit PIN you set. If you lose the PIN, the file can't be restored — please keep the PIN.",
    ...
    reviewRewardCheckingError: "An error occurred during verification. Please try again.",
    reviewRewardAlreadyUsedToday: "You have already used your extra album today. (Resets at midnight)",
    reviewRewardDuplicateHash: "This review screenshot has already been used. Please upload a new screenshot.",
    reviewRewardBrandNotFound: "The current brand name (Scripic) cannot be found. Please upload a screenshot where the app name is visible.",
    reviewRewardDefaultSuccess: "🎁 Review verification complete! An extra album creation right has been granted.",
    reviewRewardDefaultReason: "Review content could not be recognized. Please capture it so 'Scripic' is visible.",
    // Backup PIN
    ...
    privacyConsentBody:
      "This app sends your photo to Google Gemini API for AI analysis. \nAnalysis results (conversation summary and comments) or Photos or Albums are stored only on your device. No data is stored on our servers.\n\nSee our Privacy Policy for details.",
  ...
  ko: {
    ...
    firstMemoryTagline: "사진만으로는 담기지 않는 기억까지 기록하세요",
    firstMemoryHint: "사진 1~3장이면 충분해요",
    ...
    offlineNotice: "인터넷 연결을 확인해주세요.",
    connectionError: "연결에 문제가 생겼어요",
    incompleteResponse: "AI 응답이 잠시 끊겼어요. 다시 시도해볼까요?",
    incompleteRetry: "다시 시도",
    incompleteResponseFinal: "지금은 AI와 대화가 조금 어려워요. 잠시 후에 다시 시도해 주세요.",
    edit: "편집",
    save: "저장",
    cancel: "취소",
    title: "제목",
    ...
    viewNow: "지금 보기",
    savedToDocuments: "Documents 폴더에 저장했어요",
    ...
    backupInfoPinBody:
      "모든 백업 파일은 사용자가 설정한 4자리 PIN으로 암호화돼요. PIN을 잃어버리면 복원할 수 없으니 꼭 기억해 주세요.",
    ...
    reviewRewardCheckingError: "확인 중 오류가 발생했습니다. 다시 시도해 주세요.",
    reviewRewardAlreadyUsedToday: "오늘 이미 추가 앨범을 사용하셨습니다. (자정에 초기화됩니다)",
    reviewRewardDuplicateHash: "이미 사용한 후기 이미지예요. 새로운 후기 스크린샷을 올려주세요.",
    reviewRewardBrandNotFound: "이 앱의 현재 브랜드(Scripic / 스크립픽)가 보이지 않아요. 앱이름이 보이는 후기 스크린샷을 올려주세요.",
    reviewRewardDefaultSuccess: "🎁 후기 업로드 확인 완료! 추가 앨범 생성권이 지급되었습니다.",
    reviewRewardDefaultReason: "후기 내용을 인식하지 못했어요. 'Scripic'이 보이게 캡처해 주세요.",
    // Backup PIN
    ...
    addLocation: "장소 추가",
    removeLocation: "장소 삭제",
    pickPeriodTitle: "기간 선택",
    clear: "지우기",
    ...
    chatCoachIntroBody:
      "AI가 미처 생각하지 못한 순간들을 물어 볼 꺼에요, 사진에 담기지 않은 기억들을 꺼내보세요. 작은 디테일, 그날의 분위기, 함께한 사람까지. \n(단, AI는 정확하지 않으며 틀릴 수 도 있어요)",
