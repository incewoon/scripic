...
const dict = {
  en: {
    ...
    photoPermDesc: "Pick the photos you'd like to weave into a story. Moara only opens the ones you choose.",
    ...
    backupInvalid: "This file isn't a valid Moara backup.",
  ...
  ko: {
    ...
    backupInvalid: "올바른 Moara 백업 파일이 아니에요.",
