...
const dict = {
  ...
  ko: {
    ...
    freeNoticeBody:
      "Scripic는 현재 무료로 제공돼요. \n\n베타 기간 동안은 한 앨범에 사진 3장까지, 하루 1개 앨범 만들기로 제한돼요.",
    freeNoticeSoon:
      "SNS에 후기를 올려주시면 하루에 한번만 앨범을 하나 더 만들 수 있어요 \n\n(한번 인증된 후기는 재사용할 수 없어요.)",
    gotIt: "확인했어요",
    // Storage diagnostics
    ...
    chatCoachIntroBody:
      "AI가 미처 생각하지 못한 순간들을 물어 볼 꺼에요, 사진에 담기지 않은 기억들을 꺼내보세요. 작은 디테일, 그날의 분위기, 함께한 사람까지.(단, AI는 정확하지 않으며 틀릴 수 도 있어요)",
