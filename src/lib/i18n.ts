...
const dict = {
  en: {
    ...
    photoPermTitle: "Let Rementory see your photos",
    photoPermDesc: "Pick the photos you'd like to weave into a story. Rementory only opens the ones you choose.",
    ...
    freeNoticeBody: "Rementory is free right now. While in beta, each album holds up to 3 photos and you can create 1 album per day.",
    ...
    backupInvalid: "This file isn't a valid Rementory backup.",
    ...
    themeWarmDesc: "Soft beige & coral — the original Rementory look.",
    ...
    reviewRewardDesc: "Post about Rementory on Instagram, Facebook, Threads, X, or any social media, then upload the screenshot. AI will verify it and grant you 1 extra album today.",
  ...
  ko: {
    ...
    freeNoticeBody: "Rementory는 현재 무료로 제공돼요. 베타 기간 동안은 한 앨범에 사진 3장까지, 하루 1개 앨범 만들기로 제한돼요.",
    ...
    backupInvalid: "올바른 Rementory 백업 파일이 아니에요.",
    ...
    themeWarm: "웜 크림",
    themeWarmDesc: "포근한 베이지와 코랄 — 기본 Rementory 분위기예요.",
    ...
    reviewRewardDesc: "Instagram, Facebook, Threads, X 등 SNS에 올린 Rementory 후기 화면을 캡처해서 올려주세요. AI가 확인 후 오늘 추가 앨범 1개를 드려요.",
