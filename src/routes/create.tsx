...
function Create() {
  ...
  const [mode, setModeState] = useState<ChatMode>(() => loadDefault(MODE_KEY, VALID_MODES, "story"));
  ...
  return (
    <div className="mx-auto max-w-md flex flex-col h-[100dvh]">
      <div ref={scrollRef} className="flex-1 overflow-y-auto px-5 pt-[calc(0.75rem+env(safe-area-inset-top))] pb-1">
        ...
        <div className="card-info mb-4 rounded-2xl px-3 py-2.5 flex items-start gap-2.5">
