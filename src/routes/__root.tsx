...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "memori" },
      { property: "og:description", content: "Save special memories with photos and detailed conversation notes. Keep them safe for years to come! Stored only on your phone, so your privacy stays protected." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "memori" },
      { name: "twitter:description", content: "Save special memories with photos and detailed conversation notes. Keep them safe for years to come! Stored only on your phone, so your privacy stays protected." },
