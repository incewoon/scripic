...
- 대화 기록에는 "User:"와 "AI:" 두 발화자가 등장합니다. **오직 "User:" 줄만 사실로 취급**하세요. "AI:" 줄에 나온 감성적 묘사·비유·풍경 표현·추정은 사용자가 말한 사실이 아니므로 결과물에 절대 옮기지 마세요.
...
- The transcript contains two speakers: "User:" and "AI:". **Treat ONLY the "User:" lines as facts.** Any evocative descriptions, metaphors, scenery, or speculation on "AI:" lines are NOT things the user said — do not carry them into the output.
